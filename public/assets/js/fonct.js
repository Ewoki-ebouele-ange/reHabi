...
$(document).ready(function() {
    ...
    $('.delete-button').on('click', function() {
        ...
        if (result.isConfirmed) {
            $.ajax({
            url: '/fonct/delete/' + deleteFonctId, // Votre route de suppression
            type: 'DELETE',
            data: {
            ...
            success: function(response) {
                ...
                updateFonctList(); // Recharger la liste des employés
                } else {
                Swal.fire(
                    'Echoué!',
                    "Échec de la suppression du fonct. Veuillez réessayer.",
                    'error'
                );
                }
            },
