        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myCenterModalLabel">Modifier l'entité</h4>
                ...
                <div class="modal-body">
                    <form role="form" id="editForm" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label" for="code_entite">Code</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="libelle_entite">Libelle</label>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header d-flex justify-content-between">
                        <h4 class="modal-title" id="myCenterModalLabel">Ajouter une entite</h4>
                        <div class="d-flex gap-2">
                            <div class="fileupload add-new-plus">
                                <form role="form" id='upload-form' action="{{ route('entite.import') }}"  method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="modal-body">
                        <form role="form" id="addForm" action="{{ route('entite.add') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="code_entite">Code</label>
                                <input id="code_entite" name="code_entite" type="text" class="form-control" value="{{old('code_entite')}}">
                                @error('code_entite')
                                    {{$message}}
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="libelle_entite">libelle</label>
                                <input id="libelle_entite" name="libelle_entite" type="text" class="form-control" value="{{old('libelle_entite')}}">
                                @error('libelle_entite')
                                    {{$message}}
                                @enderror
                            </div>
        ...
        <div class="modal fade" id="custom-modal-tree" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('entite.export') }}" method="POST" class="d-flex flex-column aligns-items-center">
                            @csrf
...
@section("script")
    <script src="{{asset("/assets/js/entite.js")}}"></script>
     <!-- third party js -->
