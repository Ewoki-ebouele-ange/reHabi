                    ...
                    <div class="formular">
                        <form method="POST" action="" class="flex flex-col gap-4">
                            ...
                            <div class="lab_inp flex flex-col gap-2">
                                ...
                                <input id="code_module" name="code_module" type="text" class="rounded-xl w-50" value="{{old('code_module')}}">
                                @error('code_module')
                                    {{$message}}
                                @enderror
                            </div>
                            <div class="lab_inp flex flex-col gap-2">
                                <label for="libelle_module">Entrer le libellé</label>
                                <input id="libelle_module" name="libelle_module" type="text" class="rounded-xl w-50" value="{{old('libelle_module')}}"> 
