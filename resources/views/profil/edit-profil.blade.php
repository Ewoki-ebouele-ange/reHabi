                    ...
                    <div class="formular">
                        <form method="POST" action="" class="flex flex-col gap-4">
                            ...
                            <div class="lab_inp flex flex-col gap-2">
                                ...
                                <input id="code_profil" name="code_profil" type="text" class="rounded-xl w-50" value="{{old('code_profil', $profil->code_profil)}}">
                                @error('code_profil')
                                    {{$message}}
                                @enderror
                            </div>
                            <div class="lab_inp flex flex-col gap-2">
                                <label for="libelle_profil">Entrer le libelle</label>
                                <input id="libelle_profil" name="libelle_profil" type="text" class="rounded-xl w-50" value="{{old('libelle_profil', $profil->libelle_profil)}}"> 
