                    ...
                    <div class="formular">
                        <form method="POST" action="" class="flex flex-col gap-4">
                            ...
                            <div class="lab_inp flex flex-col gap-2">
                                ...
                                <input id="nom" name="nom" type="text" class="rounded-xl w-50" value="{{old('nom')}}">
                                @error('nom')
                                    {{$message}}
                                @enderror
                            </div>
                            <div class="lab_inp flex flex-col gap-2">
                                ...
                                <input id="matricule" name="matricule" type="text" class="rounded-xl w-50" value="{{old('matricule')}}"> 
                                @error('matricule')
                                    {{$message}}
                                @enderror
                            </div>
