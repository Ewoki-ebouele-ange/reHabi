                    ...
                    <div class="formular">
                        <form method="POST" action="" class="flex flex-col gap-4">
                            ...
                            <div class="lab_inp flex flex-col gap-2">
                                ...
                                <input id="code_entite" name="code_entite" type="text" class="rounded-xl w-50" value="{{old('code_entite')}}">
                                @error('code_entite')
                                    {{$message}}
                                @enderror
                            </div>
                            <div class="lab_inp flex flex-col gap-2">
                                <label for="libelle_entite">Entrer le libellé</label>
                                <input id="libelle_entite" name="libelle_entite" type="text" class="rounded-xl w-50" value="{{old('libelle_entite')}}"> 
