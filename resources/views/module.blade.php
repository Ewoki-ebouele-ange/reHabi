        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myCenterModalLabel">Modifier le module</h4>
                ...
                <div class="modal-body">
                    <form role="form" id="editForm" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label" for="code_module">Code</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="libelle_module">Libelle</label>
    ...
    <!-- /.modal -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header d-flex justify-content-between">
                        <h4 class="modal-title" id="myCenterModalLabel">Ajouter un module</h4>
                        <div class="d-flex gap-2">
                            <div class="fileupload add-new-plus">
                                <form role="form" id='upload-form' action="{{ route('module.import') }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="modal-body">
                        <form role="form" id="addForm" action="{{ route('module.add') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="code_module">Code</label>
                                <input id="code_module" name="code_module" type="text" class="form-control" value="{{old('code_module')}}">
                                @error('code_module')
                                    {{$message}}
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="libelle_module">libelle</label>
                                <input id="libelle_module" name="libelle_module" type="text" class="form-control" value="{{old('libelle_module')}}">
                                @error('libelle_module')
                                    {{$message}}
                                @enderror
                            </div>
        ...
        <div class="modal fade" id="custom-modal-four" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myCenterModalLabel">Ajouter un/plusieurs module(s)</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                    </div>
                    <div class="modal-body">
                        <form method='POST' action="{{ route('module.import') }}" class="d-flex flex-column aligns-items-center">
                            @csrf
        ...
        <div class="modal fade" id="custom-modal-tree" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('module.export') }}" method="POST" class="d-flex flex-column aligns-items-center">
                            @csrf
