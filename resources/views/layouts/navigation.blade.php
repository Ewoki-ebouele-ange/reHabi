        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('entite')" :active="request()->routeIs('entite')">
                        {{ __('Entités') }}
                    </x-nav-link>
                    <x-nav-link :href="route('poste')" :active="request()->routeIs('poste')">
                        {{ __('Postes') }}
                    </x-nav-link>
                    <x-nav-link :href="route('application')" :active="request()->routeIs('application')">
                        {{ __('Applications') }}
                    </x-nav-link>
                    <x-nav-link :href="route('module')" :active="request()->routeIs('module')">
                        {{ __('Modules') }}
                    </x-nav-link>
